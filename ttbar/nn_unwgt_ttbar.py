...
with open('/home/lb_linux/nn_unwgt/ttbar/info_wgt_events_5iter_ttbar.txt', 'r') as infof:
...
plt.xlabel('epoch')
plt.legend(loc='best')
plt.savefig("/home/lb_linux/nn_unwgt/ttbar/plot_16_16_{}_{}_{}_{}_seed{}_train.pdf".format(norm, lossfunc, output, unwgt, seed_all), format='pdf')
...
fig_eff.savefig("/home/lb_linux/nn_unwgt/ttbar/plot_16_16_{}_{}_{}_{}_{}_seed{}_eff.pdf".format(norm, lossfunc, output, maxfunc, unwgt, seed_all), format='pdf')
fig_ws.savefig("/home/lb_linux/nn_unwgt/ttbar/plot_16_16_{}_{}_{}_{}_{}_seed{}_ws.pdf".format(norm, lossfunc, output, maxfunc, unwgt, seed_all), format='pdf')
fig_zk.savefig("/home/lb_linux/nn_unwgt/ttbar/plot_16_16_{}_{}_{}_{}_{}_seed{}_zk.pdf".format(norm, lossfunc, output, maxfunc, unwgt, seed_all), format='pdf')
